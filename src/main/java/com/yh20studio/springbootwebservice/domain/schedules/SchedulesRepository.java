...
public interface SchedulesRepository extends JpaRepository<Schedules, Long> {
    ...
    @Query("SELECT p " +
        ...
        +
        "ORDER BY p.id ASC ")
    Stream<Schedules> findMySchedulesByStartDateAndEndDate(
        @Param(value = "start_date") LocalDateTime start_date,
        @Param(value = "end_date") LocalDateTime end_date, @Param(value = "member") Long member);
