...
public class FocusTodosController {
    ...
    public FocusTodosMainResponseDto saveFocusTodos(@RequestBody FocusTodosSaveRequestDto focusTodosSaveRequestDto){
        return focusTodosService.save(focusTodosSaveRequestDto);
    }

    // Put Method
    @PutMapping(value="/{id}", produces = "application/json; charset=UTF-8")
    public FocusTodosMainResponseDto updateFocusTodos(@PathVariable("id") Long id, @RequestBody FocusTodosSaveRequestDto focusTodosSaveRequestDto){
    ...
    public FocusTodosMainResponseDto successFocusTodos(@PathVariable("id") Long id, @RequestBody FocusTodosSaveRequestDto focusTodosSaveRequestDto){
