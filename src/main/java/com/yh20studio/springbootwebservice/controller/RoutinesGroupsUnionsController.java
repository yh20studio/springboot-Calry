...
public class RoutinesGroupsUnionsController {
    ...
    public RoutinesGroupsUnionsMainResponseDto saveRoutinesGroupsUnions(@RequestBody RoutinesGroupsUnionsSaveRequestDto dto){
        return routinesGroupsUnionsService.saveRoutinesGroupsUnions(dto);
    }

    // Put Method
    @PutMapping(value="/{id}", produces = "application/json; charset=UTF-8")
    public RoutinesGroupsUnionsMainResponseDto updateRoutinesGroupsUnions(@PathVariable("id") Long id, @RequestBody RoutinesGroupsUnionsUpdateRequestDto dto){
