...
public class RoutinesGroupsUnionsService {
    ...
    public RoutinesGroupsUnionsMainResponseDto saveRoutinesGroupsUnions(
        RoutinesGroupsUnionsSaveRequestDto dto) {
    ...
    @Transactional
    public RoutinesGroupsUnionsMainResponseDto updateRoutinesGroupsUnions(Long id,
        RoutinesGroupsUnionsUpdateRequestDto dto) {
        ...
        Collection<RoutinesGroups> needToDeleteRoutinesGroups = routinesGroupsUnions
            .updateRoutinesGroups(routinesGroupsList);
        ...
        return new RoutinesGroupsUnionsMainResponseDto(
            routinesGroupsUnionsRepository.save(routinesGroupsUnions));
    ...
    public Long deleteRoutinesGroupsUnions(Long id) {
        RoutinesGroupsUnions routinesGroupsUnions = routinesGroupsUnionsRepository.findById(id)
            .orElseThrow(() -> new RestException(HttpStatus.NOT_FOUND,
                "해당 RoutinesGroupsUnions 값을 찾을 수 없습니다."));
