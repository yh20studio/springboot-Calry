...
public class LabelsService {
    ...
    public List<LabelsMainResponseDto> getMyAllDesc() {
        ...
        return labelsRepository.findLabelsByMemberOrderBySequence(memberId)
            .map(LabelsMainResponseDto::new).collect(Collectors.toList());
    }
    ...
    public List<LabelsMainResponseDto> update(LabelsListDto labelsListDto) {
        ...
        return updatedLabelsList.stream().map(LabelsMainResponseDto::new)
            .collect(Collectors.toList());
    }
